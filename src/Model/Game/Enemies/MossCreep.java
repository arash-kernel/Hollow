...
public class MossCreep extends Entity implements GettingHit{
	...
	static {
		...
		for (String name : animNames) {
			animations.addAnimation(name, "src/Model/Game/Enemies/MossCreepAnimations/");
		}

		
		String[] soundNames = {"Hit", "Death"};
		for (String name : soundNames) {
			animations.addSound(name, "src/Model/Game/Enemies/MossCreepAnimations/Sounds/");
		}
	}

	private int tickCounter = 0;

	public MossCreep(double x, double y, Room room) {
		super(x, y, room);
		width = 50;  
		height = 50; 
		state = "Walk";
